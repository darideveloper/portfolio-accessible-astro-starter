...
tags: ['Web Development', 'Django', 'Evaluation Platform', 'PDF Reports', 'Data Analysis']
featuredImage: /projects/aft/01-aft-leadforward-dashboard-administrador-panel-control-3s.webp
---
...
<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
  <Image
    src="/projects/aft/02-aft-leadforward-dashboard-respuestas-admin-3s.webp"
  ...
  />
  <Image
    src="/projects/aft/03-aft-leadforward-dashboard-administracion-participantes-3s.webp"
  ...
  />
  <Image
    src="/projects/aft/04-aft-leadforward-acceso-plataforma-login-3s.webp"
  ...
  />
  <Image
    src="/projects/aft/05-aft-leadforward-vista-inicio-evaluacion-3s.webp"
  ...
  />
  <Image
    src="/projects/aft/06-aft-leadforward-codigo-invitacion-acceso-3s.webp"
  ...
  />
  <Image
    src="/projects/aft/07-aft-leadforward-formulario-datos-generales-3s.webp"
