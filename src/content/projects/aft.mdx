...
<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
  <img
    src="../../assets/projects/aft/02-aft-leadforward-dashboard-respuestas-admin-3s.webp"
    alt="AFT - Dashboard de administración de respuestas"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/aft/03-aft-leadforward-dashboard-administracion-participantes-3s.webp"
    alt="AFT - Dashboard de administración de participantes"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/aft/04-aft-leadforward-acceso-plataforma-login-3s.webp"
    alt="AFT - Acceso a la plataforma y login"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/aft/05-aft-leadforward-vista-inicio-evaluacion-3s.webp"
    alt="AFT - Vista de inicio de evaluación tecnológica"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/aft/06-aft-leadforward-codigo-invitacion-acceso-3s.webp"
    alt="AFT - Código de invitación para acceso a evaluación"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/aft/07-aft-leadforward-formulario-datos-generales-3s.webp"
    alt="AFT - Formulario de datos generales de participantes"
