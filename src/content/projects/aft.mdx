...
description: 'AFT es una plataforma de evaluación de competencias tecnológicas desarrollada con Django, creada para apoyar a las organizaciones en la medición del talento de sus empleados. El proyecto se centra en un módulo de generación de reportes dinámicos en PDF.'
tags: ['Web Development', 'Django', 'Education', 'PDF Reports', 'Data Analysis']
featuredImage: ../../assets/projects/aft/01-aft-leadforward-dashboard-administrador-panel-control-3s.webp
---
