...
<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
  <img
    src="../../assets/projects/itzimnarealestate/02-itzimna-real-estate-propiedades-venta-renta-3s.webp"
    alt="Itzimna Real Estate - Propiedades en venta y renta"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/itzimnarealestate/03-itzimna-real-estate-busqueda-avanzada-filtros-3s.webp"
    alt="Itzimna Real Estate - Búsqueda avanzada con filtros"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/itzimnarealestate/04-itzimna-real-estate-detalle-propiedad-informacion-3s.webp"
    alt="Itzimna Real Estate - Detalle de propiedad e información"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/itzimnarealestate/05-itzimna-real-estate-galeria-imagenes-propiedad-3s.webp"
    alt="Itzimna Real Estate - Galería de imágenes de propiedad"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/itzimnarealestate/06-itzimna-real-estate-propiedades-relacionadas-recomendaciones-3s.webp"
    alt="Itzimna Real Estate - Propiedades relacionadas y recomendaciones"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/itzimnarealestate/07-itzimna-real-estate-datos-generales-propiedad-3s.webp"
    alt="Itzimna Real Estate - Datos generales de la propiedad"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/itzimnarealestate/08-itzimna-real-estate-blog-noticias-inmobiliarias-3s.webp"
    alt="Itzimna Real Estate - Blog y noticias inmobiliarias"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/itzimnarealestate/09-itzimna-real-estate-formulario-contacto-leads-3s.webp"
    alt="Itzimna Real Estate - Formulario de contacto para leads"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/itzimnarealestate/10-itzimna-real-estate-dashboard-login-acceso-admin-3s.webp"
    alt="Itzimna Real Estate - Dashboard login y acceso administrativo"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/itzimnarealestate/11-itzimna-real-estate-dashboard-home-panel-control-3s.webp"
    alt="Itzimna Real Estate - Dashboard home y panel de control"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/itzimnarealestate/12-itzimna-real-estate-dashboard-gestion-propiedades-cms-3s.webp"
    alt="Itzimna Real Estate - Gestión de propiedades en CMS"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/itzimnarealestate/13-itzimna-real-estate-dashboard-detalle-propiedad-cms-3s.webp"
    alt="Itzimna Real Estate - Detalle de propiedad en CMS"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/itzimnarealestate/14-itzimna-real-estate-dashboard-gestion-blog-cms-3s.webp"
    alt="Itzimna Real Estate - Gestión de blog en CMS"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/itzimnarealestate/15-itzimna-real-estate-dashboard-detalle-blog-cms-3s.webp"
    alt="Itzimna Real Estate - Detalle de blog en CMS"
