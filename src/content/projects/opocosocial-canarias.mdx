...
<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
  <img
    src="../../assets/projects/opocosocial-canarias/02-opocosocial-precios-planes-suscripcion-oposiciones-3s.webp"
    alt="Opocosocial Canarias - Precios y planes de suscripción para oposiciones"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/opocosocial-canarias/03-opocosocial-servicios-preparacion-oposiciones-canarias-3s.webp"
    alt="Opocosocial Canarias - Servicios de preparación de oposiciones en Canarias"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/opocosocial-canarias/04-opocosocial-acceso-usuarios-plataforma-estudio-3s.webp"
    alt="Opocosocial Canarias - Acceso de usuarios a la plataforma de estudio"


    class="h-[250px] w-full rounded-lg object-cover"
  />
  <img
    src="../../assets/projects/opocosocial-canarias/05-opocosocial-registro-nuevos-usuarios-oposiciones-3s.webp"
    alt="Opocosocial Canarias - Registro de nuevos usuarios para oposiciones"
